...
def get_arguments():
    ...
    parser.add_argument("--data_root", type=str, default="ISIC_2019_Training_Input/ISIC_2019_Training_Input")
    ...
    parser.add_argument("--n_iters", type=int, default=25)
...
#   parser.add_argument('--input_image_path', type=str, required=True, help='Path to the single test image')
#   parser.add_argument('--num_classes', type=int, required=True, help=8)
    parser.add_argument('--input_height', type=int, default=224, help="Height of input image")
    parser.add_argument('--input_width', type=int, default=224, help="Width of input image")    
    ...
    parser.add_argument('--experiment_idx',type=str,default='./demo')# name the experiment
    parser.add_argument('--test_model', type=str, default='./test_model') # path of test model (used by eval.py)
    return parser